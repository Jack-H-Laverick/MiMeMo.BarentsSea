...
flag <- magick::image_transparent(magick::image_read("./Choices/EU flag.png"), color = "white")
...
flag <- magick::image_transparent(magick::image_read("./Choices/Norway flag.png"), color = "white")
