...
ecosystem model strathE2E*polar* for the Barents Sea. Scripts are
loosely classified into families
-*bathymetry*-*fish*-*flows*-*nemo-medusa*-*saltless*-*StrathE2E*. The
...
[here](https://jack-h-laverick.github.io/MiMeMo.BarentsSea/)

This work is part of MiMeMo. Other MiMeMo repositories cover a
parameterisation for the East Greenland Shelf, Building sediment maps
