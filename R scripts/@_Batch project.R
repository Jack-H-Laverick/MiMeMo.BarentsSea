...
# "./R scripts/bathymetry/bathymetry.03 DOMAIN CHOICES.R",                 
# "./R scripts/bathymetry/bathymetry.04 DEFINE DOMAIN.R",                  
# 
...
# 
# #"./R scripts/flows/flows.01 VC-EXTRACTION.R",                       
# "./R scripts/flows/flows.02 MAKE TRANSECTS.R",                      
# "./R scripts/flows/flows.03 LABEL TRANSECTS.R",                     
# "./R scripts/flows/flows.04 SAMPLE PERIMETER.R",                    
# "./R scripts/flows/flows.05 SAMPLE FLUXES.R",                       
# #"./R scripts/flows/flows.06 VOLUME CHECK.R",                        
# "./R scripts/flows/flows.07 PLOT EXCHANGES.R",                      
# "./R scripts/flows/flows.08 WAVES.R",                               
# 
# "./R scripts/saltless/saltless.01 ATMOSPHERE.R",                       
# "./R scripts/saltless/saltless.02 RIVER VOLUMES.R",                    
# "./R scripts/saltless/saltless.03 RIVER N CONCENTRATION.R",            
# "./R scripts/saltless/saltless.04 RIVER DIN FIX.R",                    
# "./R scripts/saltless/saltless.05 SPM.R",                              
# "./R scripts/saltless/saltless.06 HABITAT TYPES.R",                    
# "./R scripts/saltless/saltless.07 DISTURBANCE.R",                      
# "./R scripts/saltless/saltless.08 OTHER SEDIMENT SUMMARIES.R",         
# "./R scripts/saltless/saltless.09 LIGHT AND TEMP.R",                
# 
...
# "./R scripts/fish/fish.10 ICES LANDINGS PROPORTIONS.R",            
# "./R scripts/fish/fish.11 IMR TRENDS.R",                           
# "./R scripts/fish/fish.12 IMR EFFORT AND LANDINGS.R",              
# "./R scripts/fish/fish.13 EU LANDINGS.R",                          
...
# "./R scripts/fish/fish.19 INTERNATIONAL HABITAT EFFORT.R"         
# 
# ##"./R scripts/strathE2E/strathE2E.00 QUICKSTART.R",                      
# #"./R scripts/strathE2E/strathE2E.01 DIN FIX.R",                         
# #"./R scripts/strathE2E/strathE2E.01 INITIALISE MODEL.R",                
# #"./R scripts/strathE2E/strathE2E.02 COMPILE BOUNDARY FILE.R",           
# #"./R scripts/strathE2E/strathE2E.03 COMPILE PHYSICS FILE.R",            
# #"./R scripts/strathE2E/strathE2E.04 COMPILE PHYSICAL PARAMETERS.R"     
# ##"./R scripts/strathE2E/strathE2E.05 MODEL CLEANUP.R"                   
) %>% 
