...
#  Depth = "S" ; var = "Meridional"
  ...
  Samples <- st_drop_geometry(Samples)                               # Drop geometry column AFTER plot check, but before binding DFs
...
Sample <- function(file)               {
  ...
  #file <- "./Objects/Currents/c.1.1980.rds"
  #file <- "./Objects/Currents/c.1.1981.rds"
